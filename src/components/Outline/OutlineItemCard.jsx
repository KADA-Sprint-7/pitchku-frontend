...
import { GripVertical, Copy, Trash2, Check, Edit3, AlertCircle } from 'lucide-react';
...
export default function OutlineItemCard({
  ...
  return (
    <div
      ...
      onDragEnd={onDragEnd}
      className={`group relative flex items-center justify-between gap-3 p-3.5 sm:p-4 rounded-xl border transition-all ${
        isDragging
    ...
    >
      ...
      <div className="flex items-center gap-2.5 shrink-0">
        ...
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-700/80 text-[11px] font-bold text-sky-400 font-mono tracking-wider shrink-0">
